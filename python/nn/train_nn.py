...
用法：
  py -3.14 -m python.nn.train_nn --data python/data/nn_samples.json --out python/nn/value.pt
  py -3.14 -m python.nn.train_nn --data python/data/nn_samples_rl.json --init python/nn/value.pt --out python/nn/value_rl_ft.pt
"""
import argparse
import json
import os
...
from python.nn.features import branch_matrix, DEFAULT_MAX_STEPS
from python.nn.model import BranchValueNet
...
if __name__ == '__main__':
    ...
    ap.add_argument('--data', default='python/data/nn_samples.json')
    ap.add_argument('--out', default='python/nn/value.pt')
