...
def play_one_game(max_moves=30, t0=40.0, opening=None):
...
def generate_dataset(num_games=50, max_moves=30, t0=40.0, seed=1, out_path='python/data/nn_samples.json'):
    """生成并保存训练样本。"""
...
if __name__ == '__main__':
    ...
    ap.add_argument('--out', default='python/data/nn_samples.json')
    args = ap.parse_args()
