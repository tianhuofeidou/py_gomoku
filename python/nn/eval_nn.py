...
用法：
  py -3.14 -m python.nn.eval_nn --games 20 --max-moves 40 --t0 30 --model python/nn/value_rl.pt
"""
import argparse
import random
...
def play_game(nn_player, opening, max_moves=40, t0=30.0, model_path='python/nn/value.pt'):
...
def main():
    ...
    ap.add_argument('--model', default='python/nn/value.pt')
    args = ap.parse_args()

    from python.nn.data import OPENINGS
